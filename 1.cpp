...
void Excersise_3()   // Не возвратная фунция VOID исполльняющая 3 задание
{
    ...
    std::cout << (a * d + b * c) << "/" << b * d << std::endl;  // Вывод итогового результата
}
...
void Excersice_4()     // Не возвратная фунция VOID исполняющая 4 задание.
{
    ...
    {
        int a, b, c;                                                    // Инициализация переменных типа int
        double pound;                                                   // Инициализация переменной типа double, для работы с дробными числами
        ...
        c = c + b + a * 100;                                            // Вычесление уровнения для поллучения финального колличества пенсов
...
void Choice()  // Не возвратная фунция для осуществления выбора задания по номеру.
{
    ...
    while (choose != True)
    {
        ...
        else if (x == 2)     // Выбор задания 2
        {
            Excersise_2();  // Вызов функции
            choose = true;
        }

        else if (x == 3)     // Выбор задания 3
        {
            Excersise_3();  // Вызов функции
            choose = true;
        }

        else if (x == 4)     // Выбор задания 4
            choose = true;
        {
        ...
        {
            std::cout << "Выбранное вами задание не существует, выберите другое!\n"
                << "Доступные номера заданий: [1, 2, 3, 4, 5]\n";
        }
    }
