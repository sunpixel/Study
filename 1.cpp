...
void Excersise_3()   // Не возвратная фунция VOID исполльняющая 3 задание
{
    ...
    double k, l;                                                // Инифиализация переменных типа double
    ...
    k = (a * d + b * c);                                        // Получения результат числителя дроби
    l = b * d;                                                  // Получение результата делителя дроби
...
void Excersice_4()     // Не возвратная фунция VOID исполняющая 4 задание.
{
    ...
    if (x == 2)                                                         // Проверка выбора пользхователя
    {
        ...
        b = b * 12;                                                     // Получение колличества пенсов в шиллингах
        c = c + b;                                                      // Колличество пеносв в общем
        c = c / 2.4;                                                    // Получение колличества пенсов в 10-ой системе
...
void Excersise_5()
{
    ...
    old_pound = pound;                                                  // Колличетсво фунтов
    penny = int(pound * 100) % 100 * 2.4;                               // Вычесление колличества пенсов 
    shilling = penny / 12;                                              // Получение колличества шиллингов в пенсах
    penny = penny % 12;                                                 // Получения колличества пенсов
